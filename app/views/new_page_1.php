  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u2" class="ax_html_button">
        <input id="u2_input" type="submit" value="Submit"/>
      </div>

      <!-- Unnamed (Radio Button) -->
      <div id="u3" class="ax_radio_button">
        <label for="u3_input">
          <!-- Unnamed () -->
          <div id="u4" class="text">
            <p><span>Radio Button</span></p>
          </div>
        </label>
      ...
      <div id="u5" class="ax_shape">
        <img id="u5_img" class="img " src="images/new_page_1/u5.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u7" class="ax_shape">
        <img id="u7_img" class="img " src="images/new_page_1/u5.png"/>
        <!-- Unnamed () -->
