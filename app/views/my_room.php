...
<html>
  <head>
    ...
    <link href="files/my_room/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/my_room/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u8" class="ax_flow_shape">
        <img id="u8_img" class="img " src="images/my_room/u8.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u10" class="ax_flow_shape">
        <img id="u10_img" class="img " src="images/my_room/u10.png"/>
        <!-- Unnamed () -->
